---
title: "resolucao-lista1-samarone"
...
#4 teste as expressões log10(1000), log(1000),exp(log(1000)).Depois testar a expressão log2(64). verifique se você entendeu as diferentes funções logarítimicas.

```{r}

log10(1000)  #logaritimo de 1000 na base 10

log(1000) #logaritimo natural de 1000 na base exp=2.718

exp(log(1000)) #exponencial à função logarítimica natural de 1000.

log2(64) #logaritimo de 64 na base 2

```

# 5 defina as variáveis abaixo tomando cuidado ao nomear as variáveis, conforme visto em sala de aula.
...
# 6 Como você pode fazer para que a constante de (pi) seja mostrada com 20 digitos? 
...
# 7  Determine a temperatura de bulbo úmido(Tw) usando a expressão empirica stull, 2011 abaixo 
...
```{r}
knitr::include_graphics("equacao.png")
```
